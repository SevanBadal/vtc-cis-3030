...
basicMathTestOne = TestCase (assertEqual "should return (10,6,16,4)" (integralTuple (10, 6, 16, 4)) (basicMath 8 2))

basicMathTestTwo :: Test
basicMathTestTwo = TestCase (assertEqual "should return (9,-1,20,0)" (integralTuple (9, (-1), 20, 0)) (basicMath 4 5))
